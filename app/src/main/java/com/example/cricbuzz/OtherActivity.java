...
public class OtherActivity extends AppCompatActivity {
    ...
    int GTimgArr[] = {R.drawable.gt1, R.drawable.gt2, R.drawable.gt3,R.drawable.gt4,R.drawable.gt5,R.drawable.gt6,
            R.drawable.gt7,R.drawable.gt8,R.drawable.gt9,R.drawable.gt10,R.drawable.gt11};

    int CSKimgArr[]={R.drawable.gt12,R.drawable.gt13,R.drawable.gt14,R.drawable.gt15,R.drawable.gt16,R.drawable.gt17,
            R.drawable.gt18,R.drawable.gt1,R.drawable.gt2,R.drawable.gt3,R.drawable.gt4};
